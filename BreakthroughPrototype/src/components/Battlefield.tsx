...
export default function Battlefield({ state, onChooseShield, isDragging, onDropPlay, onDropShield, stagedCardId, onCancelStaged, oppStagedCardId, justBrokenPlayerShieldIdx, encounterName, portraitUrl }: Props) {
