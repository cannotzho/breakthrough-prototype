...
export default function HandArea({ state, onSelectCard, onPlayCard, onPlaceShield, onEndTurn, onDragStart, onDragEnd, onGhostMove, draggingCardId, stagedCardId }: Props) {
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2 overflow-x-auto bg-[rgba(10,15,30,0.92)] border-t-2 border-[#0f3460] min-h-[148px]">
      {/* Place Shield / End Turn buttons — only in attack phase */}
