...
export const CARDS: Record<string, CardDef> = {
  ...
  offerHelp: {
    ...
    effects: { opponentPatience: -2, priority: 2, isInterrupt: true },
    color: '#4ecca3',
  },
  ...
  composure: {
    ...
    effects: { priority: 2, isInterrupt: true },
    color: '#00d9ff',
  },
  ...
  empathize: {
    ...
    effects: { playerPatience: 2, surrenderPriority: true, shieldImmunityUntilPriority: true, isInterrupt: true },
    color: '#4ecca3',
  },
  ...
  collegeRecords: {
    ...
    cost: 2,
    effectText: 'Priority +2',
    flavorText: "Confirms her attendance and academic standing at Larkgrove Women's College.",
    effects: { priority: 2 },
    color: '#00d9ff',
  },
  ...
  bloodAnalysis: {
    ...
    flavorText: "Mary-Ann was specially recommended for the forensics workshop as a promising alchemist excelling in magical blood analysis.",
