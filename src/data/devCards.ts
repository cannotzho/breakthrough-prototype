...
export const DEV_SKILL_CARDS: CardDefinition[] = [
  ...
  },
  {
    ...
    cost: 1,
    keywords: [],
    effects: [{ type: 'TRANSFORM_TOKEN', transformSourceId: 'logical_chain', transformTargetId: 'impactful_conclusion', value: 1 }],
    color: 'Blue',
    supertype: 'Skill',
    subtype: null,
    effectText: 'Transform a Logical Chain into an Impactful Conclusion.',
    longDescription: 'Package your chain of reasoning into a devastating conclusion.',
  },
  {
    id: 'dev_hold',
    name: 'Hold Ground',
